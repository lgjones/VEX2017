...
#pragma config(Motor,  port1,           right_sweeper, tmotorVex393_HBridge, openLoop, reversed)
#pragma config(Motor,  port2,           latch2,        tmotorVex393_MC29, PIDControl, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port3,           left_launch,   tmotorVex393_MC29, PIDControl, reversed, encoderPort, I2C_4)
...
#pragma config(Motor,  port9,           left_sweeper,  tmotorVex393_MC29, openLoop)
...
task usercontrol()
{
  ...
  while (true)
  {
    ...
    if(vexRT[Btn8LXmtr2] || !finishedHoming) {
  	...
  	if(vexRT[Btn6DXmtr2] && vexRT[Btn5UXmtr2]) {
  		motor[latch2] = 127;
  	}
  	else if (vexRT[Btn6UXmtr2] && vexRT[Btn5UXmtr2]) {
  		motor[latch2] = -127;
  	}
...
void latch() {
	setMotorTarget(latch2,175*3,127,true);
}
